...
## Commands
- Start backend locally: `deno run --allow-net --allow-read --allow-env --unstable src/server.ts`
...
## Recent Changes
- 001-gitlab-vim-integration: Add initial plan and technical decisions (Lua frontend, Deno backend)
